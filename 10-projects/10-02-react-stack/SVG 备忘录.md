# SVG Icon 使用备忘录 / SVG Icon Usage Memo

  

## 1. SVG 文件规范 / SVG File Standard
...
## 2. 如何改变 SVG 图标大小 / How to Change SVG Icon Size
...
## 4. 批量处理工具与命令 / Batch Processing Tools & Commands

  

### 4.1 批量修改 SVG 宽高为 1em，并输出到新目录 / Batch set width/height to 1em and output to new dir

  

#### 安装 svgo / Install svgo
...
#### 新建 svgo.config.js（项目根目录）/ Create svgo.config.js (project root)
